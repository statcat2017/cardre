          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <span
              style={{
                fontWeight: 600,
                color:
                  guidanceForStep.readiness === "complete" || guidanceForStep.readiness === "ready"
                    ? theme.greenText
        ...
        >
          ...
          {manualBinningState && !manualBinningState.ready && (
            ...
            >
              ...
              {manualBinningState.blocked_reason && (
                <div style={{ marginTop: 4 }}>{manualBinningState.blocked_reason}</div>
              )}
            </div>
          )}
          {manualBinningState?.ready && (
            <>
              <div style={{ fontSize: 11, color: theme.greenText, marginBottom: 6 }}>
                {manualBinningState?.selected_variables?.length ||
                  _parseNSelected(guidanceForStep?.action_target) ||
                  0}{" "}
                variables selected, ready to edit.
              </div>
              {onEditManualBinning && (
                <button
