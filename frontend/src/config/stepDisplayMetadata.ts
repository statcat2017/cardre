...
export const STEP_DISPLAY_METADATA: Record<string, StepDisplayMetadata> = {
  ...
  "apply-woe-raw": {
    ...
    section: "Model Build",
    label: "Apply WOE (Raw)",
    shortDescription: "Apply bin definitions for calibration holdout",
  },
  "apply-model-raw": {
    ...
    shortDescription: "Score holdout data without score scaling",
  },
