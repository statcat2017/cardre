...
2. [07d — Binning and canonical-pathway migration](07d-binning-and-canonical-pathway-migration.md)
3. [07c — Evidence-package migration](07c-evidence-package-migration.md)
4. [07f — Legacy execution-context removal](07f-legacy-execution-context-removal.md)
5. [07e — ProjectStore removal and test migration](07e-project-store-removal-and-test-migration.md)
