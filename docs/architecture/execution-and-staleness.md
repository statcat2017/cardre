...
The `PlanExecutor` (`cardre/application/runs/execute_run.py`) is the single execution seam.
...
The `RunLifecycle` class (`cardre/application/runs/finalize_run.py`) owns generic run mechanics:
