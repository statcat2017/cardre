...
KNOWN_EXCEPTIONS: set[str] = {
    ...
    "cardre/domain/evidence/models/",
    "cardre/domain/evidence/models/apply/",
    "cardre/domain/evidence/models/binning/",
    "cardre/domain/evidence/models/diagnostics/",
    "cardre/domain/evidence/models/governance/",
    "cardre/domain/evidence/models/manifest/",
    "cardre/domain/evidence/models/model/",
    "cardre/domain/evidence/models/sample/",
    "cardre/domain/evidence/models/summary/",
    "cardre/domain/evidence/models/validation/",
    "cardre/domain/evidence/models/woe/",
    "cardre/adapters/evidence/",
    "cardre/adapters/filesystem/",
    "cardre/adapters/sqlite/",
    "cardre/adapters/system/",
    "cardre/adapters/dispatch/",
    "cardre/adapters/reporting/",
    "cardre/adapters/rendering/",
    "cardre/artifacts.py",
