...
Hard break from v1: ``STORE_SCHEMA_VERSION = 100``.
No MIGRATIONS_SQL, no backfill.  ``store_meta`` is a hard-version-check,
not a migration table.
"""

# Public schema identity used by the legacy store surface.
...
# ---------------------------------------------------------------------------
# Legacy compatibility schema for ``cardre.store.project_store``.
# ---------------------------------------------------------------------------

LEGACY_STORE_SCHEMA_FAMILY = "cardre.project_store.v2"
