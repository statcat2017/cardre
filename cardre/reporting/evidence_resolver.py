...
def resolve_run_step(
    ...
    When resolution is "exact" and resolved_branch_id is set, first tries
    the branch-scoped lookup; if that fails, falls back to branch_id=None
    (shared upstream / baseline).
    """
