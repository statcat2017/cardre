...
class LimitationCode(StrEnum):
    ...
    MISSING_SCORE_APPLICATION = "MISSING_SCORE_APPLICATION"
    MISSING_IMPLEMENTATION_EXPORTS = "MISSING_IMPLEMENTATION_EXPORTS"
    ...
    def blocker_codes(cls) -> set[LimitationCode]:
        ...
        return {
            ...
            cls.MISSING_SCORE_APPLICATION,
            cls.MISSING_IMPLEMENTATION_EXPORTS,
