...
GOVERNANCE_DISABLED = ErrorCode.GOVERNANCE_DISABLED
PLAN_VERSION_IMMUTABLE = ErrorCode.PLAN_VERSION_IMMUTABLE
STORE_VERSION_INCOMPATIBLE = ErrorCode.STORE_VERSION_INCOMPATIBLE
RUN_EXECUTION_FAILED = ErrorCode.RUN_EXECUTION_FAILED
PROJECT_NOT_FOUND = ErrorCode.PROJECT_NOT_FOUND
PLAN_NOT_FOUND = ErrorCode.PLAN_NOT_FOUND
PLAN_VERSION_NOT_FOUND = ErrorCode.PLAN_VERSION_NOT_FOUND
RUN_NOT_FOUND = ErrorCode.RUN_NOT_FOUND
ARTIFACT_NOT_FOUND = ErrorCode.ARTIFACT_NOT_FOUND
STEP_NOT_FOUND = ErrorCode.STEP_NOT_FOUND
BRANCH_NOT_FOUND = ErrorCode.BRANCH_NOT_FOUND
COMPARISON_NOT_FOUND = ErrorCode.COMPARISON_NOT_FOUND
REVIEW_NOT_FOUND = ErrorCode.REVIEW_NOT_FOUND
MISSING_PROJECT_ID = ErrorCode.MISSING_PROJECT_ID
MISSING_PROJECT_PATH = ErrorCode.MISSING_PROJECT_PATH
RAW_PROJECT_PATH_DISABLED = ErrorCode.RAW_PROJECT_PATH_DISABLED
CONCURRENT_RUN = ErrorCode.CONCURRENT_RUN
STORE_ALREADY_EXISTS = ErrorCode.STORE_ALREADY_EXISTS
INVALID_PROJECT_PATH = ErrorCode.INVALID_PROJECT_PATH
MISSING_PARAMETER = ErrorCode.MISSING_PARAMETER
PLAN_VERSION_NOT_COMMITTED = ErrorCode.PLAN_VERSION_NOT_COMMITTED
GOVERNANCE_NOT_ENABLED = ErrorCode.GOVERNANCE_NOT_ENABLED
GRAPH_VALIDATION_ERROR = ErrorCode.GRAPH_VALIDATION_ERROR
PLAN_CONTAINS_UNAVAILABLE_NODES = ErrorCode.PLAN_CONTAINS_UNAVAILABLE_NODES
RUN_NOT_RUNNING = ErrorCode.RUN_NOT_RUNNING
RUN_PLAN_VERSION_MISMATCH = ErrorCode.RUN_PLAN_VERSION_MISMATCH
MISSING_INPUT_ARTIFACT = ErrorCode.MISSING_INPUT_ARTIFACT
PARAMETER_VALIDATION_ERROR = ErrorCode.PARAMETER_VALIDATION_ERROR
ARTIFACT_READ_ERROR = ErrorCode.ARTIFACT_READ_ERROR
ARTIFACT_WRITE_ERROR = ErrorCode.ARTIFACT_WRITE_ERROR
NODE_NOT_AVAILABLE_FOR_LAUNCH = ErrorCode.NODE_NOT_AVAILABLE_FOR_LAUNCH
RUN_SCOPE_NOT_AVAILABLE_FOR_LAUNCH = ErrorCode.RUN_SCOPE_NOT_AVAILABLE_FOR_LAUNCH
BRANCH_VALIDATION_ERROR = ErrorCode.BRANCH_VALIDATION_ERROR
OPTIONAL_DEPENDENCY_NOT_INSTALLED = ErrorCode.OPTIONAL_DEPENDENCY_NOT_INSTALLED
RUN_LIFECYCLE_ERROR = ErrorCode.RUN_LIFECYCLE_ERROR
