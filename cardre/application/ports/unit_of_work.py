...
class RunRepoPort(Protocol):
    ...
    def list_successful_steps_across_plan_ordered(self, plan_id: str, step_id: str, branch_id: str | None = None) -> list[RunStep]: ...
...
class RunStepRepoPort(Protocol):
    ...
    def list_successful_steps_ordered(self, plan_version_id: str, step_id: str, branch_id: str | None = None) -> list[RunStep]: ...
...
@runtime_checkable
class ComparisonRepoPort(Protocol):
    def create_comparison(self, project_id: str, plan_id: str, baseline_branch_id: str,
                          comparison_spec_json: str, *, created_reason: str | None = None) -> str: ...
...
@runtime_checkable
class ChampionRepoPort(Protocol):
    def get_champion_assignment(self, plan_id: str,
                                champion_branch_id: str | None = None) -> dict[str, Any] | None: ...
...
class ReadOnlyUnitOfWork(Protocol):
    ...
    @property
    def comparisons(self) -> ComparisonRepoPort: ...
    @property
    def champion(self) -> ChampionRepoPort: ...
