...
@runtime_checkable
class ManualBinningRepoPort(Protocol):
    def create_review(self, plan_version_id: str, step_id: str, status: str,
                      reviewer_notes: str = "",
                      affected_downstream_step_ids: list[str] | None = None) -> Any: ...
    def get_review(self, review_id: str) -> Any | None: ...
    def list_for_project(self, project_id: str) -> list[Any]: ...
    def get_reviews_for_step(self, plan_version_id: str, step_id: str) -> list[Any]: ...
    def update_review(self, review_id: str, status: str | None = None,
...
class ReadOnlyUnitOfWork(Protocol):
    ...
    @property
    def manual_binning(self) -> ManualBinningRepoPort: ...
    @property
    def reports(self) -> ReportRepoPort: ...

    @property
    def exports(self) -> ExportRepoPort: ...
