"""ProjectResolver — registry-backed project root resolution.

Compatibility shim that delegates to ``cardre.store.project_registry``.
Imported by tests and legacy callers as
